export const ITEMS = [
  ...
  { id: "voice_changer", name: "Voice Changer", description: "Enable random voice changer for 10 seconds.", cost: 5000, rarity: "Rare", iconUrl: "https://i.imgur.com/FeIqjaU.png" },
  ...
  { id: "game_master", name: "Game Master", description: "Select an activity I have to do for 30 minutes.", cost: 50000, rarity: "Legendary", iconUrl: "https://i.imgur.com/cBPQ4vP.png" },
  { id: "equipment_master", name: "Equipment Master", description: "Swap out any single piece of equipment with your choice for a raid.", cost: 50000, rarity: "Legendary", iconUrl: "https://i.imgur.com/QioD5ut.png" },
] as const;
